...
| test | B6-TEST | G1+G4 PASS: 35 pytest pass (warning-free under -W error), ruff clean; cache-identity, 429 isolation, 503/502 mapping, concurrency smoke all covered |
