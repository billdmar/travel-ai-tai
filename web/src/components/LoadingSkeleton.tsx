export default function LoadingSkeleton() {
  return (
    <div className="mx-auto max-w-4xl space-y-6" aria-busy="true" aria-label="Generating itinerary">
      <div className="rounded-xl border border-ink-line bg-canvas-raised p-6 shadow-sm">
      ...
      {[0, 1, 2].map((i) => (
        <div key={i} className="rounded-xl border border-ink-line bg-canvas-raised p-6 shadow-sm">
          <div className="animate-pulse space-y-4 motion-reduce:animate-none">
